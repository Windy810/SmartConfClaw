              ...
              {session.timeline.map((item) => {
                ...
                return (
                  ...
                  >
                    ...
                    <p className="mt-1 line-clamp-2 text-xs text-zinc-500 dark:text-zinc-400">{item.summary}</p>
                  </button>
                );
              })}
            </div>
      ...
      <Card className="min-h-0">
        ...
        <CardContent className="space-y-5 p-4">
          ...
          <div className="rounded-xl border border-zinc-200/80 bg-zinc-50/60 p-4 dark:border-zinc-800 dark:bg-zinc-900/50">
            ...
            <p className="text-sm leading-relaxed text-zinc-600 dark:text-zinc-300">{session.extendedReport}</p>
          </div>
        </CardContent>
      </Card>
    </div>
