...
export const mockAcademicSession: AcademicSession = {
  ...
  qaSimulator: [
    {
      question: "How does this method compare to standard adapters in terms of latency?",
...
export const mockGraphNodes: GraphNode[] = [
  { id: "method-router-aware-lora", label: "Router-Aware LoRA", group: "method" },
  { id: "method-lora", label: "LoRA", group: "method" },
  { id: "dataset-multilingual-sum", label: "Multilingual Summarization Set", group: "dataset" },
  { id: "metric-latency", label: "Serving Latency", group: "metric" },
  { id: "author-neurips-speaker", label: "Primary Author", group: "author" },
];

export const mockGraphEdges: GraphEdge[] = [
  { source: "method-router-aware-lora", target: "method-lora", relation: "extends" },
  { source: "method-router-aware-lora", target: "dataset-multilingual-sum", relation: "evaluated_on" },
  { source: "method-router-aware-lora", target: "metric-latency", relation: "improves" },
  { source: "author-neurips-speaker", target: "method-router-aware-lora", relation: "proposed" },
];
